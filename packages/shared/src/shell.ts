...
const PATH_CAPTURE_START = "__MATCHA_PATH_START__";
const PATH_CAPTURE_END = "__MATCHA_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__MATCHA_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__MATCHA_ENV_${name}_END__`;
}
