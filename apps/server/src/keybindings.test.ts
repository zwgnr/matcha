import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@matcha/contracts";
...
import { KeybindingsConfigError } from "@matcha/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "matcha-keybindings-test-",
        }),
      ),
    ),
  );
